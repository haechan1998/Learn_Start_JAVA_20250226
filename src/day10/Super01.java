...
public class Super01 {
	...
	public static void main(String[] args) {
		/* 상속 : 부모의 것을 자식에게 물려누는 것.
		 * - 멤버변수 / 메서드 만 상속가능.
		 * - 클래스의 확장 개념.
		 * - 상속을 하는 이유 : 재사용을 해서 중복코드를 줄이고, 유지보수를 쉽게 하기 위해서이다.
		 * 
		 * class A(부모클래스), class B(자식)
		 * 
		 * class B extends A {
		 * 
		 * }
		 ...
		 * - 접근제어자가 private 라면 자식클래스가 접근 불가능하다.
		 * - 접근제어자가 protected : 상속받는 자식에게 허용하는 제어자.
		 * - 상속은 1개만 가능. 부모가 2명이 될 수 없다. (단일 상속이 원칙)
		 * 
		 * 
		 * 
		 * */
