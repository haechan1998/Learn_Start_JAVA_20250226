...
public class File01 {
	...
	public static void main(String[] args) {
		 ...
		 * 	- FileInputStream, FileOutputStrea, FileReader, FileWriter ...
		 * 
		 * 보조스트림 : 읽고 쓰는 기능이 없고, 추가적인 기능을 더해주기 위한 스트림
		 * 	- Buffered ~ 이런식으로 되어있으면 보조스트림...
		 * 
		 * 
		 * 
		 * */
		...
		// 표준 출력(모니터 = 콘솔) 스트림
		System.out.println("print"); // out 이 printStream.
